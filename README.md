# uart_core
<span style="font-size:20px;">UART 底层核心模块说明</span>

这是一个全双工 UART 底层硬件模块，发送端（TX）与接收端（RX）相互独立、可同时工作。

<span style="font-size:18px;">模块参数配置</font>
